...
class reserve:
    def __init__(
        ...
        self.fast_probe_timeout = (
            float(os.getenv("CX_FAST_PROBE_CONNECT_TIMEOUT", "0.155")),
            float(os.getenv("CX_FAST_PROBE_READ_TIMEOUT", "0.155")),
        )
        ...
        self.token_fetch_timeout = max(
            0.001,
            float(os.getenv("CX_TOKEN_FETCH_TIMEOUT_MS", "250")) / 1000.0,
        )
        self.headers = {
